...
$bdd->query("DELETE FROM agenda WHERE date_en<'$dateactuelle';");

//-------------------------------

$resultat_count=$bdd->query("SELECT count(*) FROM agenda ORDER BY date_en ASC ;");
$nb_ligne=$resultat_count->fetchColumn();


$resultat=$bdd->query("SELECT * FROM agenda ORDER BY date_en ASC ;");
