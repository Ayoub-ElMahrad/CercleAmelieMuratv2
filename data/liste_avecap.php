...
$query="SELECT COUNT(*) FROM membres WHERE adresse!='';";
$res=$bdd->query($query);
$nb=$res->fetchColumn();


?>
CONTACTS AVEC ADRESSE POSTALE (AVEC OUS SANS ADRESSE ÉLECTRONIQUE)<?echo $annee;

$query="SELECT * FROM membres WHERE adresse!='' ORDER BY nom,prenom;";
$res=$bdd->query($query);
